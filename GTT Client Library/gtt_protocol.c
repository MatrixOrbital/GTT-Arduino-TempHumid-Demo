...
eStatusCode gtt25_baseobject_set_property_number(gtt_device* device, uint16_t ObjectID, uint16_t PropertyID, float Value)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
...
eStatusCode gtt25_baseobject_get_property_number(gtt_device* device, uint16_t ObjectID, uint16_t PropertyID, float* out_Value)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
...
eStatusCode gtt25_dataset_set_data(gtt_device* device, uint16_t ObjectID, uint16_t Index, float Value)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
...
eStatusCode gtt25_dataset_push_data(gtt_device* device, uint16_t ObjectID, float Value)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
...
eStatusCode gtt25_get_dataset_default_value(gtt_device * device, uint16_t ObjectID, float* result)
{
	return gtt25_baseobject_get_property_number(device,ObjectID,ePropertyID_DataSet_DefaultValue,(float*)result);
}

eStatusCode gtt25_set_dataset_default_value(gtt_device * device, uint16_t ObjectID, float value)
{
...
eStatusCode gtt25_get_axis_mode(gtt_device * device, uint16_t ObjectID, eAxisMode* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_Axis_Mode,(uint8_t*)result);
}

eStatusCode gtt25_set_axis_mode(gtt_device * device, uint16_t ObjectID, eAxisMode value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_Axis_Mode,value);
}

eStatusCode gtt25_get_axis_min_value(gtt_device * device, uint16_t ObjectID, float* result)
{
	return gtt25_baseobject_get_property_number(device,ObjectID,ePropertyID_Axis_MinValue,(float*)result);
}

eStatusCode gtt25_set_axis_min_value(gtt_device * device, uint16_t ObjectID, float value)
{
	return gtt25_baseobject_set_property_number(device,ObjectID,ePropertyID_Axis_MinValue,value);
}

eStatusCode gtt25_get_axis_max_value(gtt_device * device, uint16_t ObjectID, float* result)
{
	return gtt25_baseobject_get_property_number(device,ObjectID,ePropertyID_Axis_MaxValue,(float*)result);
}

eStatusCode gtt25_set_axis_max_value(gtt_device * device, uint16_t ObjectID, float value)
{
	return gtt25_baseobject_set_property_number(device,ObjectID,ePropertyID_Axis_MaxValue,value);
}

eStatusCode gtt25_get_axis_size(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_Axis_Size,(uint16_t*)result);
}

eStatusCode gtt25_set_axis_size(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_Axis_Size,value);
}

eStatusCode gtt25_get_axis_dock(gtt_device * device, uint16_t ObjectID, eAxisDock* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_Axis_Dock,(uint8_t*)result);
}

eStatusCode gtt25_set_axis_dock(gtt_device * device, uint16_t ObjectID, eAxisDock value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_Axis_Dock,value);
}

eStatusCode gtt25_get_axis_font_object(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_Axis_FontObject,(uint16_t*)result);
}

eStatusCode gtt25_set_axis_font_object(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_Axis_FontObject,value);
}

eStatusCode gtt25_get_axis_font_size(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_Axis_FontSize,(uint16_t*)result);
}

eStatusCode gtt25_set_axis_font_size(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_Axis_FontSize,value);
}

eStatusCode gtt25_get_axis_label_dataset(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_Axis_LabelDataset,(uint16_t*)result);
}

eStatusCode gtt25_set_axis_label_dataset(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_Axis_LabelDataset,value);
}

eStatusCode gtt25_get_axis_orientation(gtt_device * device, uint16_t ObjectID, eAxisType* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_Axis_Orientation,(uint8_t*)result);
}

eStatusCode gtt25_set_axis_orientation(gtt_device * device, uint16_t ObjectID, eAxisType value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_Axis_Orientation,value);
}

eStatusCode gtt25_get_axis_fill_type(gtt_device * device, uint16_t ObjectID, eFillType* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_Axis_FillType,(uint8_t*)result);
}

eStatusCode gtt25_set_axis_fill_type(gtt_device * device, uint16_t ObjectID, eFillType value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_Axis_FillType,value);
}

eStatusCode gtt25_get_axis_bar_padding(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_Axis_BarPadding,(uint8_t*)result);
}

eStatusCode gtt25_set_axis_bar_padding(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_Axis_BarPadding,value);
}

eStatusCode gtt25_get_baseplot_data_source(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_BasePlot_DataSource,(uint16_t*)result);
}

eStatusCode gtt25_set_baseplot_data_source(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_BasePlot_DataSource,value);
}

eStatusCode gtt25_get_baseplot_vertical_axis(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_BasePlot_VerticalAxis,(uint16_t*)result);
}

eStatusCode gtt25_set_baseplot_vertical_axis(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_BasePlot_VerticalAxis,value);
}

eStatusCode gtt25_get_baseplot_horizontal_axis(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_BasePlot_HorizontalAxis,(uint16_t*)result);
}

eStatusCode gtt25_set_baseplot_horizontal_axis(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_BasePlot_HorizontalAxis,value);
}

eStatusCode gtt25_get_lineplot_r(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_LinePlot_R,(uint8_t*)result);
}

eStatusCode gtt25_set_lineplot_r(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_LinePlot_R,value);
}

eStatusCode gtt25_get_lineplot_g(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_LinePlot_G,(uint8_t*)result);
}

eStatusCode gtt25_set_lineplot_g(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_LinePlot_G,value);
}

eStatusCode gtt25_get_lineplot_b(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_LinePlot_B,(uint8_t*)result);
}

eStatusCode gtt25_set_lineplot_b(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_LinePlot_B,value);
}

eStatusCode gtt25_get_barplot_r(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_BarPlot_R,(uint8_t*)result);
}

eStatusCode gtt25_set_barplot_r(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_BarPlot_R,value);
}

eStatusCode gtt25_get_barplot_g(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_BarPlot_G,(uint8_t*)result);
}

eStatusCode gtt25_set_barplot_g(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_BarPlot_G,value);
}

eStatusCode gtt25_get_barplot_b(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_BarPlot_B,(uint8_t*)result);
}

eStatusCode gtt25_set_barplot_b(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_BarPlot_B,value);
}

eStatusCode gtt25_get_barplot_prefered_width(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_BarPlot_PreferedWidth,(uint16_t*)result);
}

eStatusCode gtt25_set_barplot_prefered_width(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_BarPlot_PreferedWidth,value);
}

eStatusCode gtt25_get_barplot_auto_width(gtt_device * device, uint16_t ObjectID, eOnOff* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_BarPlot_AutoWidth,(uint8_t*)result);
}

eStatusCode gtt25_set_barplot_auto_width(gtt_device * device, uint16_t ObjectID, eOnOff value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_BarPlot_AutoWidth,value);
}

eStatusCode gtt25_get_graphchart_child_list_object(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_GraphChart_ChildListObject,(uint16_t*)result);
}

eStatusCode gtt25_set_graphchart_child_list_object(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_GraphChart_ChildListObject,value);
}

eStatusCode gtt25_get_graphchart_background_r(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_GraphChart_BackgroundR,(uint8_t*)result);
}

eStatusCode gtt25_set_graphchart_background_r(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_GraphChart_BackgroundR,value);
}

eStatusCode gtt25_get_graphchart_background_g(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_GraphChart_BackgroundG,(uint8_t*)result);
}

eStatusCode gtt25_set_graphchart_background_g(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_GraphChart_BackgroundG,value);
}

eStatusCode gtt25_get_graphchart_background_b(gtt_device * device, uint16_t ObjectID, uint8_t* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_GraphChart_BackgroundB,(uint8_t*)result);
}

eStatusCode gtt25_set_graphchart_background_b(gtt_device * device, uint16_t ObjectID, uint8_t value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_GraphChart_BackgroundB,value);
}

eStatusCode gtt25_get_graphchart_background_bitmap(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_GraphChart_BackgroundBitmap,(uint16_t*)result);
}

eStatusCode gtt25_set_graphchart_background_bitmap(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_GraphChart_BackgroundBitmap,value);
}

eStatusCode gtt25_textdataset_initialize(gtt_device* device, uint16_t ObjectID)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_TextDataSet_Initialize);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_end(device);

	gtt_packetbuilder_send(device);
	size_t index = gtt_parser_waitpacket_250(device,eGtt25Command_TextDataSet_Initialize);

	uint8_t status = gtt_parser_getU8(device,index,&index);
	return (eStatusCode)status;
}

eStatusCode gtt25_textdataset_set_data(gtt_device* device, uint16_t ObjectID, uint16_t Index, gtt_text  Value)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_TextDataSet_SetData);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeU16(device,Index);
	gtt_packetbuilder_writeText(device,Value);
	gtt_packetbuilder_end(device);
	...
	gtt_packetbuilder_send(device);
	size_t index = gtt_parser_waitpacket_250(device,eGtt25Command_TextDataSet_SetData);

	uint8_t status = gtt_parser_getU8(device,index,&index);
	return (eStatusCode)status;
}

eStatusCode gtt25_textdataset_push_data(gtt_device* device, uint16_t ObjectID, gtt_text  Value)
{
	gtt_packetbuilder_start(device);
	gtt_packetbuilder_writeU8(device,GTT_PREFIX);
	gtt_packetbuilder_writeU8(device,250);
	gtt_packetbuilder_writeU16(device,eGtt25Command_TextDataSet_PushData);
	gtt_packetbuilder_writeU16(device,ObjectID);
	gtt_packetbuilder_writeText(device,Value);
	gtt_packetbuilder_end(device);

	gtt_packetbuilder_send(device);
	size_t index = gtt_parser_waitpacket_250(device,eGtt25Command_TextDataSet_PushData);

	uint8_t status = gtt_parser_getU8(device,index,&index);
	return (eStatusCode)status;
}

eStatusCode gtt25_get_textdataset_mode(gtt_device * device, uint16_t ObjectID, eDataSetMode* result)
{
	return gtt25_baseobject_get_property_u8(device,ObjectID,ePropertyID_TextDataSet_Mode,(uint8_t*)result);
}

eStatusCode gtt25_set_textdataset_mode(gtt_device * device, uint16_t ObjectID, eDataSetMode value)
{
	return gtt25_baseobject_set_property_u8(device,ObjectID,ePropertyID_TextDataSet_Mode,value);
}

eStatusCode gtt25_get_textdataset_length(gtt_device * device, uint16_t ObjectID, uint16_t* result)
{
	return gtt25_baseobject_get_property_u16(device,ObjectID,ePropertyID_TextDataSet_Length,(uint16_t*)result);
}

eStatusCode gtt25_set_textdataset_length(gtt_device * device, uint16_t ObjectID, uint16_t value)
{
	return gtt25_baseobject_set_property_u16(device,ObjectID,ePropertyID_TextDataSet_Length,value);
}

eStatusCode gtt25_get_textdataset_default_value(gtt_device * device, uint16_t ObjectID, gtt_text * result)
{
	return gtt25_baseobject_get_property_text(device,ObjectID,ePropertyID_TextDataSet_DefaultValue,(gtt_text *)result);
}

eStatusCode gtt25_set_textdataset_default_value(gtt_device * device, uint16_t ObjectID, gtt_text  value)
{
	return gtt25_baseobject_set_property_text(device,ObjectID,ePropertyID_TextDataSet_DefaultValue,value);
}
